 ...
 * @author corte
 */
public class Registrar_Compra extends javax.swing.JDialog {

    /**
     * Creates new form Registrar
     */
    public Registrar_Compra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Registrar_Compra dialog = new Registrar_Compra(new javax.swing.JFrame(), true);
