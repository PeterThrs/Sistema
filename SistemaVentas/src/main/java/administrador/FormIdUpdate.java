...
public class FormIdUpdate extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese el id del Usuario a Editar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormIdUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormIdUpdate dialog = new FormIdUpdate(new javax.swing.JFrame(), true);
