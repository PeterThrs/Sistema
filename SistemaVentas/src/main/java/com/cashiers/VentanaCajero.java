...
public class VentanaCajero extends javax.swing.JFrame {
    ...
    private void AgregarConfiguración () {
        ...
        Configuracion.robotoItalic13(this.jLabelProducto, this.jLabelCantidad, 
                this.jLabelPrecio, this.jLabelImporte, this.jLabelSubtotal,this.jLabelTotal,jLabelIva);
        Configuracion.foreground(CodigoColor.cLetrasNegro,this.jLabelProducto, this.jLabelCantidad, 
                this.jLabelPrecio, this.jLabelImporte, this.jLabelSubtotal,this.jLabelTotal,jLabelIva);
        ...
        Configuracion.robotoItalic13(this.jTextFieldPrecio, this.jTextFieldImporte,this.jTextFieldSubtotal,this.totaldecompra,this.jTextFieldIVA);
        ...
        Configuracion.robotoItalic13(this.jButtonRegistro,this.jButtonCobrar,this.jButtonCancelar,this.jButtonSalir);
